...
func (x *Message) GetUpdateTime() string {
	if x != nil {
		return x.UpdateTime
	}
	return ""
...
func (x *MessageListResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *MessageListResponse) GetPage() *PageMap {
	if x != nil {
		return x.Page
	}
	return nil
...
var file_message_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x85, 0x01, 0x0a, 0x13, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1f, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x4d, 0x61,
	0x70, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x32, 0x4b, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x07, 0x47, 0x65, 0x74,
	0x4d, 0x61, 0x6e, 0x79, 0x12, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x4e, 0x75,
	0x6d, 0x50, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x4d,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*MessageListResponse)(nil), // 1: pb.MessageListResponse
	(*PageMap)(nil),             // 2: pb.PageMap
	(*PageNumPageSize)(nil),     // 3: pb.PageNumPageSize
}
var file_message_proto_depIdxs = []int32{
	0, // 0: pb.MessageListResponse.messages:type_name -> pb.Message
	2, // 1: pb.MessageListResponse.page:type_name -> pb.PageMap
	3, // 2: pb.MessageService.GetMany:input_type -> pb.PageNumPageSize
	1, // 3: pb.MessageService.GetMany:output_type -> pb.MessageListResponse
